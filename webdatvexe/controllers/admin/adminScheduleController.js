  ...
  async updateSchedule(req, res) {
    try {
      ...
      if (!scheduleData.route_id) {
        throw new Error('Vui lòng chọn tuyến xe');
      }
      ...
      if (!scheduleData.departure_time) {
        throw new Error('Vui lòng nhập giờ khởi hành');
      }
      
      if (!scheduleData.arrival_time) {
        throw new Error('Vui lòng nhập giờ đến');
      }
      
      if (!scheduleData.bus_type) {
      ...
      if (scheduleData.available_seats === undefined) {
        throw new Error('Vui lòng nhập số ghế trống');
      }
